                  ...
                  Row(
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                        ...
                        label: Text(isDesktop ? "ADD COLLEGE" : "ADD"),
                        style: ElevatedButton.styleFrom(
                          backgroundColor: Colors.green[700],
                          foregroundColor: Colors.white,
                          padding: EdgeInsets.symmetric(horizontal: isDesktop ? 20 : 12, vertical: 15),
          ...
          sliver: StreamBuilder<List<CollegeModel>>(
            ...
            builder: (context, snapshot) {
              if (snapshot.hasError) {
                return SliverToBoxAdapter(child: AppErrorHandler.buildErrorWidget(snapshot.error, () => setState(() {})));
              }
              if (snapshot.connectionState == ConnectionState.waiting) {
                return SliverToBoxAdapter(child: AppErrorHandler.buildLoadingWidget());
              }
